...
export const alt = "Vackerbackens Medicinska Fotvård";
...
export default async function Image({
  ...
  const page = seoPages.find((p) => p.slug === params.slug);
  const title = page?.hero.title ?? "Medicinsk fotvård i Luleå";
  const eyebrow = page?.hero.eyebrow ?? "Vackerbackens Medicinska Fotvård";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          >
            Diplomerad fotterapeut · Vackerbacken, Luleå · Fri parkering
          </p>
        </div>
